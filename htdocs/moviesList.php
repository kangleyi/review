		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					...
					echo '<form id="ff" action="moviesList.php" method="POST">';
...
EOT;
							...
							foreach($moives as $value){ 
								...
								echo '<td><a href="moviesEdit.php?id='.$value['id'].'" >修改</a> | ';
	...
	<script type="text/javascript">
		function deletes(id){
			$.get("http://localhost:8080/review/movie/delete?id="+id,function(r){
                    if(r.code==200){
